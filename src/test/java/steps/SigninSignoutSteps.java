...
public class SigninSignoutSteps {
    ...
    @Given("^(.*), N11 anasayfasını açar$")
    public void kullanıcı_N11_Anasayfasını_Açar(String actorName) throws Throwable {
    ...
    @Then("^Kullanıcı, N11 ([^\\\"]*) ve ([^\\\"]*) bilgisini görür$")
    public void kullanıcı_N11_Anasayfasını_Görür(String title, String signIn) throws Throwable {
